...
///@return 완료된 문자열 배열
//////////////////////////////////////////////////////////////////////////
void String::SplitString(vector<string>* out_result, string origin, string tok)
{
	out_result->clear();
	...
	while ((cutAt = (int)origin.find_first_of(tok)) != origin.npos)
	{
		if (cutAt > 0) //자르는 위치가 0보다크면
			out_result->push_back(origin.substr(0, cutAt));
...
void String::SplitString(vector<wstring>* out_result, wstring origin, wstring tok)
{
	out_result->clear();
