...
int Random::InternalSample()
{
	...
	if (value == MathHelper::IntMax)
		--value;

	if (value < 0)
		value += MathHelper::IntMax;
...
int Random::Next(int minValue, int maxValue)
{
	...
	if (temp <= (long)MathHelper::IntMax)
...
{
	int seedValue = 161803398 - (seed == MathHelper::IntMax ? MathHelper::IntMax : MathHelper::Abs(seed));
